...
for PlusDay in `seq $StartSeq $EndSeq`; do
  ...
  URL="$NCSS/$MODEL/$EXPT?$VARS&$NORTH&$SOUTH&$EAST&$WEST&disableProjSubset=on&horizStride-1&time_start=1994-01-01T12%3A00%3A00Z&time_end=1994-01-02&T09%3A00%3A00Z$&timeStride=1&vertStride=39&addLatLon=true&accept=netcdf4"
