...
# -*- coding: utf-8 -*-
#
# Script to loop on timespan (day / week / month or year) to optimize dataset requests 
# (heavy in terms of number of files to be manipulated).
...
username_cmems = 'oscott'
password_cmems = 'CMEMS_SCOTT_2021'
...
for key, value in dict_id.items():
    ...
    if buffer_flag:
# removed the emoticon thing that was here as it was causing a problem 
